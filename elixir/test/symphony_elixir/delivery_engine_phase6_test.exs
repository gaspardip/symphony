...
defmodule SymphonyElixir.DeliveryEnginePhase6Test do
  ...
  test "checkout blocks generic git failures" do
    ...
    assert result =
             DeliveryEngine.run(workspace, issue, nil,
               command_runner: fn
                 "git", ["fetch", "origin", "main"], _opts -> {"boom", 1}
  ...
  defp already_merged_command_runner("git", ["fetch", "origin", "main"], _opts),
    do: {"", 0}
  ...
  defp post_merge_command_runner("git", ["fetch", "origin", "main"], _opts),
    do: {"", 0}
  ...
  defp ready_merge_command_runner("git", ["fetch", "origin", "main"], _opts),
    do: {"", 0}
